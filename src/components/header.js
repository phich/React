        ...
        return (
            ...
            <div className="navbar-custom-menu">
                ...
                <li className="dropdown messages-menu">
                    ...
                    <ul className="menu">
                        ...
                        <li>
                            <a href="#">
                            <div className="pull-left">
                                <img src="dist/img/user3-128x128.jpg" className="img-circle" alt="User Image"></img>
                            </div>
                            <h4>
                        ...
                        <li>
                            <a href="#">
                            <div className="pull-left">
                                <img src="dist/img/user4-128x128.jpg" className="img-circle" alt="User Image"></img>
                            </div>
                            <h4>
                                Developers
                ...
                <li className="dropdown user user-menu">
                    <a href="#" className="dropdown-toggle" data-toggle="dropdown">
                    <img src="dist/img/user2-160x160.jpg" className="user-image" alt="User Image"></img>
